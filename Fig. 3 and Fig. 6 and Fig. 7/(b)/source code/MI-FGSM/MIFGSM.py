"""
The main function of this code file is to use the MI-FGSM white-box attack method to perform untargeted attacks and generate adversarial samples under the Li norm constraint.
...
class MIFGSM(Attack):
    def __init__(self, model, eps=4 / 255 * (2.4285 + 2.0357), alpha=0.01, steps=3, decay=1.0):
