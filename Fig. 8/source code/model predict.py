...
def main():
    ...
    with torch.no_grad():
        ...
        top_probs, top_indices = torch.topk(predict, 50)
    ...
    # print("class: {:10}   Classification probability: {:.5f}   Classification value: {:.5f}".format(class_indict[str(500)], predict[500].numpy(),
    #                                                                   output[500].numpy()))
